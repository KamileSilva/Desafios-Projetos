...
function createCactus() {
  ...
  let leftTimer = setInterval(() => {
    ...
    //dando o contato para o game over
      ...
      document.body.innerHTML = '<h1 class="game-over">Fim de jogo</h1> <h3 class="game-over"> Pressione F5 para jogar novamente</h3><p class="game-over"><br><br>Desenvolvido por: Kamile Silva </p>';
    } 
